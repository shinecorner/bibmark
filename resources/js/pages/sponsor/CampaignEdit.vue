<template>
    <sponsor-common :sponsor="sponsor", :campaign="campaign" :activeLink="navLink">
            ...
            <form id="validation-form">
                <div class="row add-campaign-row input-form ">
                    <div class="col-12">
                        ...
                        <div class="input-wrap">
                            <div class="left-side2"></div>
                            <div class="right-side2"><span class="caption">Edit Campaign</span></div>
                        </div>
                        <div class="input-wrap">
...
<script src="./CampaignEdit.js"></script>
